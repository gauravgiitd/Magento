      ...
      <View style={[styles.container, this.props.style]}>
        ...
        <View style={styles.content}>
          <Heading1 style={styles.h1}>
            Let friends view your cart in the iAdore app?
          </Heading1>
          <Paragraph style={styles.p}>
            This will not post to Facebook. Only friends using the iAdore app will
            be able to see your cart in their My Cart tab.
          </Paragraph>
        </View>
      </View>
    );
